...
/**
 * Classe qui represente les classes filles 
 * @author BICI
 */
...
public abstract class ClassFille extends ClassMAPTable{
    ...
    /**
     * Donner du nom à la classe mère
     * @param nomClasseMer le nom de la classe mère
     * @throws Exception
     */
    ...
    /**
     * Setter le champs de liaison entre fille et mère
     * @param liaisonMere le champs de liaison entre fille et mère
     */
