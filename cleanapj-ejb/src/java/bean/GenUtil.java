...
public abstract class GenUtil implements java.io.Serializable
{
   ...
   * @param nomtable
   * @param nomClasse
   * @param c connexion ouverte pour la base de donnée
   */
   ...
   * @param nomtable
   * @param nomClasse
   * @param nbCM nombre de champ à mapper
   */
  ...
  /**
   * Obtenir tous les attributs d'une classe
   */
 ...
 */
 ...
 /*
  *@ Methode permettant de gerer les objets envoyés en fonction du num de Page
 */
...
//      System.out.println("REQUESTE : SELECT * FROM " + getNomTable() + " WHERE "+makeWhere(numChamp,valeur)+" "+apresWhere);
