...
public class UserEJBBean implements UserEJB {
    ...
    public MapUtilisateur getU() {
        return u;
    }

    public void setU(MapUtilisateur u) {
        this.u = u;
    }
    ...
    public MapUtilisateur testeValide(String user, String pass, String interim, String service) throws Exception {
        try {
            ...
            return (MapUtilisateur) uI.testeValide(user, pass);
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    public Object createObjectMultiple(ClassMAPTable mere, String colonneMere, ClassMAPTable[] fille) throws Exception {
        ...
        try {
            ...
            if (mere instanceof ClassMere && fille.length > 0 && fille[0] instanceof ClassFille) {
                ...
                ((ClassMere) mere).createObject(this.getUser().getTuppleID(), c);
                return mere;
            }
