...
//    System.out.println("critere="+critere);
    ...
    /**
     * Obtnenir un objet de mapping avec les attributs avec les valeurs des critère de recherches
    ...
    /**
     * Obtenir les colonnes d'intervalles
    ...
    /**
     * Lien à appeler suite à l'appui du bouton rechercher
     * @return lien
     */
    ...
    /**
     * Requete SQL après la clause where pour filtrer le resultat
     * @return  Requete SQL
     */
    ...
    /**
     * Paramètre supplémentaire à mettre après le lien de recherche
     * @return paramètre supplémentaire 
     */
    ...
    /**
     * Liste des colonnes à afficher sur la table de resultat
    ...
    /**
     * la liste des colonnes à afficher sur le tableau par défaut 
